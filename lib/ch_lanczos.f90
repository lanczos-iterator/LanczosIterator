subroutine ch_lanczos(n, nevec, eval, evec, variance, resolution,&
  ...
  external  matvec
!---------------------------------------------
!  finds lowest NEVEC eigenvalues and eigenvectors of a NxN complex-Hermitian
...
!---------------------------------------------
    ...
    logical, parameter :: vector_is_real = .false.
...
20  format(' CH_LANCZOS: lowest', i5,'  eigenvectors of complex hermitian matrix, dim=',i16,&
